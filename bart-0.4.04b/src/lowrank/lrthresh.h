...
extern const struct operator_p_s* lrthresh_create(const long dims_lev[DIMS], _Bool randshift, unsigned long mflags, const long blkdims[MAX_LEV][DIMS],
    float lambda, _Bool noise, int remove_mean, _Bool overlapping_blocks);

extern const struct operator_p_s* lrthresh_createx(const long dims_lev[DIMS], _Bool randshift, unsigned long mflags, const long blkdims[MAX_LEV][DIMS],
    float lambda, _Bool noise, int remove_mean, _Bool overlapping_blocks, unsigned int option);
