...
extern struct linop_s* linop_chainAdj(const struct linop_s* a, const struct linop_s* b);
extern struct linop_s* linop_chainNormal(const struct linop_s* a, const struct linop_s* b);
