		...
		struct iter_monitor_s* monitor)
{
	...
	// md_copy_dims(operator_domain(normaleq_op)->N,tmp_dims,operator_domain(normaleq_op)->dims);
	// debug_print_dims(DP_INFO,16,tmp_dims);
	// debug_printf(DP_INFO,"A\n");
	// complex float* tmp = create_cfl("/tmp/tp0a0f4512_e67b_4476_b170_ef89f4b01392out1978", 16,tmp_dims);
	// debug_printf(DP_INFO,"B\n");
	// debug_printf(DP_INFO,"B1\n");
	// debug_printf(DP_INFO,"B15\n");
	// md_clear(16,tmp_dims, tmp, CFL_SIZE);
